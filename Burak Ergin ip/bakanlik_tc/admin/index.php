...
<form id="form1" name="form1" method="post" action="giris_kontrol.php">
  <div>
		...
		<div class="giris_yap_ana_div">
				...
				<div class="admin_giris_logo"><img src="admin_images/gthbLogo.png" width="50" height="50"></div>
	<div class="hizalama_bitir"></div>				
				<div class="giris_yapin">ADMİN PANELİNE GİRİŞ YAP</div>
	...
	<div class="hizalama_bitir"></div>
		...
		<div class="kullanici"><input type="text" name="kad" class="kullanici_text"  
