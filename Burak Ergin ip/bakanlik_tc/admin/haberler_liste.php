...
<div class="hizalama_bitir"></div>
		<?
        	$sql=" select * from haberler order by h_tarih asc";
		...
		?>		
			...
			<a href="index.php?s=duyurular&did=<? echo $gel['h_id'];?>"><div class="tarihler">
		<? echo substr($gel['h_tarih'],2,2),".";?>
		<? echo substr($gel['h_tarih'],5,2),".";?>
		<? echo substr($gel['h_tarih'],0,4);?></div></a>
				
			<a href="index.php?s=duyurular&did=<? echo $gel['h_id'];?>"><div class="metin"><? echo $gel['h_baslik'];?></div></a>
